...
import eu_img from "../assets/flag_of_Europe.png";
import gr_flag from "../assets/greek_flag.png";
import athina from "../assets/uni_logo.png";
  ...
  return (
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center">© 2024 Team 8 ~ / Anna - Chris - Orestis /
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="https://github.com/annegog/myStudies" class="text-gray-500 hover:text-gray-900 ms-5">
