    ...
    return (
        <div>
            ...
            <div className="mt-10 px-4 lg:px-16 xl:px-32">
                {open && !declaration && (
                    <div className="justify-center items-center text-center">
                        <h2 className="text-xl font-semibold leading-none text-orange-400 pe-1"> 
                            Έχουν ανοίξει οι δηλώσεις μαθημάτων. <br/> Όλοι οι φοιτητές καλούνται να πραγματοποιήσουν την δήλωση τους εως και τις {end_date}.
                        </h2>
                ...
                {open && declaration && (
                    <div className="justify-center items-center text-center">
                        <h2 style={{marginTop: "0.5rem"}} className="text-xl font-semibold leading-none text-green-400 pe-1">
                            Έχει πραγματοποιηθεί Δήλωση Μαθημάτων στις {last_decl}, μπορεί να γίνει τροποποίηση της.
                        </h2>

                        <h2 style={{marginTop: "0.5rem"}} className="text-xl font-bold leading-none text-red-800 pe-1">
            ...
            <div className="flex items-center justify-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-5 md:px-16 xl:px-32">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-20">
                        <div style={{ width:"100%"}} className="p-10 bg-white rounded-lg text-center mt-5">
                            <h2 className="text-xl font-bold leading-none text-gray-900 pe-1 mb-5"> Μέσος Όρος </h2>
                        ...
                        <div style={{ width:"100%"}} className="p-10 bg-white rounded-lg text-center">
                            <h2 className="text-xl font-bold leading-none text-gray-900 pe-1 mb-2"> Περασμένα Μαθήματα </h2>
                            <div className="grid grid-cols-1 items-center border-gray-200 border-t justify-between">
                            <div className="flex justify-between items-center pt-5"></div>
