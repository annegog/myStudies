    ...
    return (
        <div>
            ...
            <div className="flex w-full flex-col items-stretch mt-4 px-16 max-md:max-w-full max-md:px-5">
                <div className="bg-zinc-300 flex justify-between gap-8 pl-16  pt-4 pb-7 rounded-3xl items-start max-md:max-w-full max-md:flex-wrap max-md:pl-5">
                    ...
                    <div className="self-stretch flex grow basis-[0%] flex-col max-md:max-w-full">
                        <div className="text-black text-xl font-light self-stretch max-md:max-w-full">
                            <h2> Όνομα: {name} </h2>
                            <h2 className="mt-5"> E-mail: {email} </h2>
                            <h2 className="mt-5"> Ιδιότητα: {status} </h2>
                        </div>
                    </div>

                    <div className="self-stretch flex grow basis-[0%] flex-col max-md:max-w-full">
                        <div className="text-black text-xl font-light self-stretch max-md:max-w-full">
                            <h2> Αριθμός μητρώου: {ID} </h2>
                            <h2 className="mt-5"> Σχολή - Τμήμα: {univeristy} </h2>
                            <h2 className="mt-5"> Μέλος από: {registrationDate} </h2>
                        </div>
                    </div>
                </div>

                <div className="flex w-[1200px] max-w-full items-stretch justify-between gap-5 ml-20 mt-6 self-start max-md:flex-wrap">
                ...
                <div className="flex w-[1360px] max-w-full items-stretch justify-between gap-5 ml-20 mt-6 self-start max-md:flex-wrap">
                    <div className="flex justify-between gap-5 items-starti items-stretch ml-5 max-md:w-full max-md:ml-0">
                        <div className="bg-zinc-300 flex grow flex-col items-stretch w-full pl-3 pr-7 py-2.5 rounded-3xl max-md:max-w-full max-md:mt-10 max-md:pr-5">
                            <div className="justify-center text-black text-xl font-medium"> Όνομα Πατέρα: Αντώνης </div>
                            <div className="justify-center text-black text-xl font-medium mt-3"> Όνομα Μητέρας: Αντωνία </div>
                            <div className="justify-center text-black text-xl font-medium mt-3"> Ημερομηνία Γέννησης: 23/06/2006 </div>
                            <div className="justify-center text-black text-xl font-medium mt-3"> Οικογενειακή Κατάσταση: Άγαμος </div>
                            <div className="justify-center text-black text-xl font-medium mt-3.5"> Αριθμός Αδελφών: - </div>
                            ...
                            <div className="justify-center text-black text-xl font-medium mt-3.5"> Πόλη/Χωριό Γέννησης: ΑΘΗΝΩΝ ΑΤΤΙΚΗΣ </div>
                            <div className="justify-center text-black text-xl font-medium mt-3"> Αριθμός Ταυτότητας: ΑΚ336699 </div>
                            <div className="justify-center text-black text-xl font-medium mt-3"> Εκδούσα Αρχή: Κερατσινίου </div>
                            <div className="justify-center text-black text-xl font-medium mt-3.5"> AMKA: 23060622553 </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between gap-5 items-starti items-stretch ml-5 max-md:w-full max-md:ml-0">
                        <div className="bg-zinc-300 flex grow flex-col items-stretch w-full pt-2 pb-10 px-3 rounded-3xl max-md:max-w-full max-md:mt-10">
                            <div className="text-black text-xl font-medium whitespace-nowrap mr-3.5 max-md:mr-2.5"> Μόνιμη Διεύθυνση Κατοικίας: Αιόλου 45 </div>
                            <div className="justify-center text-black text-xl font-medium mt-3.5"> Μόνιμη Πόλη Κατοικίας: Αθήνα </div>
                            ...
                            <div className="justify-center text-black text-xl font-medium mt-3"> ΤΚ Μόνιμης Κατοικίας: 55443 </div>
                            <div className="justify-center text-black text-xl font-medium mt-3.5"> Προσωρινή Διεύθυνση Κατοικίας: - </div>
                            <div className="justify-center text-black text-xl font-medium whitespace-nowrap mt-3"> Προσωρινή Πόλη Κατοικίας: - </div>
                            <div className="justify-center text-black text-xl font-medium whitespace-nowrap mt-3.5"> Τηλέφωνο Προσωρινής Κατοικίας: - </div>
                            <div className="justify-center text-black text-xl font-medium whitespace-nowrap mt-3"> ΤΚ Προσωρινής Κατοικίας: - </div>
                            <div className="justify-center text-black text-xl font-medium mr-3.5 mt-3 max-md:mr-2.5"> Διεύθυνση Ηλεκτρονικού Ταχυδρομείου: - </div>
                        </div>
                    </div>
                </div>
            </div>
