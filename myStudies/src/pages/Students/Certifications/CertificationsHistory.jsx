            ...
            <ol class="flex flex-row items-center">
                ...
                <li class="flex flex-col items-center">
                    <div class="flex items-center justify-center">
                        ...
                        <Link to={`/student/certifications/${id}`} class="inline-flex items-center text-sm text-gray-700 hover:text-green-700 font-medium dark:text-gray-400 dark:hover:text-white"> Πιστοποιητικά </Link>
                    </div>
                </li>
                ...
                {requests.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center">
                        <h2 className="text-center text-2xl font-semibold text-red-800 m-28">
                            Δεν βρέθηκε ιστορικό αιτήσεων για κάποιο πιστοποιητικό. <br /> Σιγουρευτείτε ότι έχετε αιτηθεί τουλάχιστον ένα.
                        </h2>
