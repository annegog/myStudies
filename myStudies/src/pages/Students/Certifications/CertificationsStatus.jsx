            ...
            <div>
                {requests.length > 0 ? (
                    requests.map((request, index) => (
                        <div key={index} className="flex items-center justify-center m-3 cursor-pointer info-container">
                            {status ? (
                                <div className="flex flex-row">
                                    <p> {request.certificationType} </p>
                                    <p className="text-green-500 pl-3"> Περαιωμένη </p>
                                </div>
                            ) : (
                                <div className="flex flex-row items-center">
                                    <p> {request.certificationType} </p>
                                    <p className="text-orange-500 pl-3"> Σε αναμονή </p>
                                </div>
                            )}
                        </div>
                    ))
